...
def path_new(graph,start,end,backtrace_path):
    ...
    for i in graph[k]:
        ...
        if flag == 0:
            ...
            if u == 0:
                backtrace_path_1 = path_new(graph,i,end,li1)
                len1=len(backtrace_path_1)
                print('back and len1',backtrace_path_1,len1)

            if u == 1:
                backtrace_path_2 = path_new(graph,i,end,li2)
                len2=len(backtrace_path_2)
                print('back and len2',backtrace_path_2,len2)

            if u == 2:
                backtrace_path_3 = path_new(graph,i,end,li3)
                len3=len(backtrace_path_3)
                print('back and len3',backtrace_path_3,len3)
